...
(defconst wonima-emacs-autosave-directory
  (expand-file-name "autosave/" wonima-emacs-state-directory)
  "A directory to store Emacs autosave files.
It is under `wonima-emacs-state-directory'")
(defconst wonima-emacs-backup-directory
  (expand-file-name "backup/" wonima-emacs-state-directory)
  "A directory to store Emacs backup files.
It is under `wonima-emacs-state-directory'")
(dolist (dir (list wonima-emacs-autosave-directory
                   wonima-emacs-backup-directory))
...
(setopt auto-save-list-file-prefix
        (expand-file-name ".saves-"
                          (expand-file-name "auto-save-list" wonima-emacs-state-directory)))
